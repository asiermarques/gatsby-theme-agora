...
import {AgendaCollectionDTO, AgendaDTO} from "../../src/modules/agenda/infrastructure/dto/AgendaDTO";
...
export const agendaCollectionDTOWithBadTalkConfigurationStub = ():AgendaCollectionDTO => {
    const dto = agendaCollectionDTOBasicStub();
    dto.agendas[0].content[0].key = "invalid_talk_key"
    return dto;
};

export const agendaCollectionDTOWithBadTrackContentTypeConfigurationStub = ():AgendaCollectionDTO => {
    const dto = agendaCollectionDTOBasicStub();
